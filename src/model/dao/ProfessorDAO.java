    ...
    public List<Professor> read(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                ArrayList <Disciplina> listaDisciplinasProfessor = new ArrayList<>();
                ...
                for (Disciplina disciplina : listaDisciplinasGeral){
                    for (String codigo : listaCodigosDisciplinas){
                        if (disciplina.getCodigo().equals(codigo)){
                            listaDisciplinasProfessor.add(disciplina);
                            break;
                        }
                    }
                }
                ...
                professor.setListaDisciplinas(listaDisciplinasProfessor);
